...
public class SerializedObserverTest {
    ...
    private Subscriber<String> serializedSubscriber(Subscriber<String> o) {
        return new SerializedSubscriber<T>(o);
    }
    ...
    public void runOutOfOrderConcurrencyTest() {
        ...
        try {
            ...
            Subscriber<String> w = serializedSubscriber(new SafeSubscriber<T>(tw));
    ...
    public void testNotificationDelay() throws InterruptedException {
        ...
        try {
            ...
            for (int i = 0; i < n; i++) {
                ...
                TestSubscriber<String> to = new TestSubscriber<T>(new Observer<String>() {
    ...
    private static class TestConcurrencySubscriber extends Observer<String> {
         ...
         */
        private final LinkedBlockingQueue<TestConcurrencySubscriberEvent> events = new LinkedBlockingQueue<T>();
    ...
    public void testSerializeNull() {
        final AtomicReference<Subscriber<Integer>> serial = new AtomicReference<T>();
        ...
        SerializedSubscriber<Integer> sobs = new SerializedSubscriber<T>(to);
        serial.set(sobs);
    ...
    public void testErrorReentry() {
        ...
        SerializedSubscriber<Integer> sobs = new SerializedSubscriber<T>(ts);
        serial.set(sobs);
